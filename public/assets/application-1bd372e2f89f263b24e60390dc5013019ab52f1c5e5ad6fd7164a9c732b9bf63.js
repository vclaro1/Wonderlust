...
(function() {
  ...
  jQuery(function() {
    return $('#search').autocomplete({
      ...
      return $('<li>').data('ui-autocomplete-item', item).append('<span class="img">', '<img src="' + item.image_url + '" />', '</span>', '<span class="title">' + item.name + '</span>', '<span class="author">' + item.trips + '</span>', '<span class="price">' + 'User since:' + item.user_since + '</span>').appendTo(ul);
    };
  });
