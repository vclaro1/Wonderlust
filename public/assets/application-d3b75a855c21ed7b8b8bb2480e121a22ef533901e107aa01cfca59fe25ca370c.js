...
(function() {
  jQuery(function() {
    ...
    }).data('autocomplete-ui')._renderItem = function(ul, item) {
      var markup;
      markup = ['<span class="img">', '<img src="' + item.image_url + '" />', '</span>', '<span class="title">' + item.name + '</span>', '<span class="author">' + item.trips + '</span>', '<span class="price">' + "User since:" + item.user_since + '</span>'];
