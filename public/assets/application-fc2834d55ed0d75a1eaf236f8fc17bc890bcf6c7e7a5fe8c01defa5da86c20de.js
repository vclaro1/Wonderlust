...
(function() {
  jQuery(function() {
    return $('#search').autocomplete({
      ...
      var markup;
      markup = ['<span class="img">', '<img src="' + item.image_url + '" />', '</span>', '<span class="title">' + item.title + '</span>', '<span class="author">' + item.author + '</span>', '<span class="price">' + item.price + '</span>'];
